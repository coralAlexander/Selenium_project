...
public class Constant {
    ...
    public static class MobileReplenishmentTestData{
        public static final String MOBILE_PAYMENT_PHONE_NUMBER= "4544545455";
        public static final String MOBILE_PAYMENT_CARD = "450690934274797";
        public static final String MOBILE_PAYMENT_CARD_EXP_DATE = "06/22 ";
